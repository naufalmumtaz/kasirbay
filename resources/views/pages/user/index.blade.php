...
<script>
    $(function () {
        ...
        $('#myTable').on('click', '.edit', function(){
            var id = $(this).data('id');
            $.get("/admin/supplier/edit/" + id, function(data) {
                $('#editModal form').attr('action', `/admin/supplier/update/${data.id}`);
                $('#editModal input#name').val(data.name);
                $('#editModal input#phone').val(data.phone);
                $('#editModal textarea#address').val(data.address);
                $('#editModal textarea#description').val(data.description);
            });
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form method="post" id="editForm">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Ubah Supplier</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
